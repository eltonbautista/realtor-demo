...
export default function HomeContact() {
  return (
    <section
      id="contact"
      className="relative w-full min-h-[80vh] flex items-center justify-center bg-white overflow-hidden"
    >
      <div className="relative py-12 px-4 sm:px-8 max-w-5xl mx-auto my-16 flex flex-col md:flex-row gap-12 md:gap-20 rounded-3xl border border-[#e6eaf1] bg-white">
